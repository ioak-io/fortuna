      ...
      <div>
        ...
        <div className="getting-started--steps realm-top-2">
          ...
          <div className="typography-4">
            ...
            product into Fortuna.
          </div>
          <div className="typography-7">Set Fortuna URL in your product</div>
          <div className="typography-4">
            To provide seemless experience to your users, add a link from your
            product to Fortuna. By triggering a button for example from your
            product, your users will be securely transferred to Fortuna with
            their details.
          </div>
          <div className="typography-7">
            Securely transmit user information to Fortuna
          </div>
          <div className="typography-4">
