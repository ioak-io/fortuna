...
import {
  ...
  CSSVARIABLES_DARK,
  CSSVARIABLES_LIGHT,
  DASHBOARD_BUDGET_ACTUAL_COLOR_SCHEME,
} from '../service';
          ...
          datasets: [
            {
              ...config,
              label: 'Budget',
              borderColor: DASHBOARD_BUDGET_ACTUAL_COLOR_SCHEME[1],
              data: props.data.budget,
              pointBackgroundColor: DASHBOARD_BUDGET_ACTUAL_COLOR_SCHEME[1],
              pointHoverBackgroundColor:
                DASHBOARD_BUDGET_ACTUAL_COLOR_SCHEME[0],
              fill: {
                target: '+1',
                above: DASHBOARD_BUDGET_ACTUAL_COLOR_SCHEME[2],
              },
            },
            {
              ...config,
              label: 'Actual',
              borderColor: DASHBOARD_BUDGET_ACTUAL_COLOR_SCHEME[4],
              data: props.data.actual,
              pointBackgroundColor: DASHBOARD_BUDGET_ACTUAL_COLOR_SCHEME[4],
              pointHoverBackgroundColor:
                DASHBOARD_BUDGET_ACTUAL_COLOR_SCHEME[3],
              fill: {
                target: '-1',
                above: DASHBOARD_BUDGET_ACTUAL_COLOR_SCHEME[5],
                // below: '#92ae5620',
              },
            },
          ],
